...
import lemonBottleImage from '../../assets/images/promotional/lemon bottle.png';
import lemonBottleTreatmentAreas from '../../assets/images/promotional/lemon bottle treatment areas.png';
...
const lemonBottle = () => (
	<React.Fragment>
		...
		<Section background='#F8F8F8'>
			<Informative image={lemonBottleTreatmentAreas} main='Areas that can be treated using lemon bottle' reversed>
				<Descriptive
					data={[
						{
							description: 'Jaw'
