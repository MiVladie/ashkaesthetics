...
const Home = () => {
	const {
		...
		query {
			bannerImage: file(relativePath: { eq: "assets/images/promotional/page_home.jpg" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			microbladingIcon: file(relativePath: { eq: "assets/icons/microblading.png" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			...
			waxingIcon: file(relativePath: { eq: "assets/icons/waxing.png" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			mensTreatmentsIcon: file(relativePath: { eq: "assets/icons/mens treatments.png" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			...
			galleryImage02: file(relativePath: { eq: "assets/images/gallery/5.jpg" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			galleryImage03: file(relativePath: { eq: "assets/images/gallery/9.jpg" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
	...
	return (
		<Layout>
			...
			<Section linkTo='/gallery' linkText='View more'>
