...
const Microblading = () => {
	...
	return (
		<Layout>
			<Preface image={microbladingImage} main='Microblading' />
...
export const Head = () => <Seo title='Microblading' />;
