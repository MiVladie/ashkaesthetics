...
const EyesAndBrows = () => {
	const { eyesAndBrowsPrefaceImage, eyesAndBrowsPriceListImage } = useStaticQuery(graphql`
		query {
			eyesAndBrowsPrefaceImage: file(relativePath: { eq: "assets/images/promotional/eyes & brows.jpg" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
			eyesAndBrowsPriceListImage: file(relativePath: { eq: "assets/images/promotional/eyes & brows 2.jpg" }) {
				childImageSharp {
					gatsbyImageData
				}
			}
	...
	return (
		<Layout>
			<Preface image={eyesAndBrowsPrefaceImage} main='Eyes & Brows' />
			...
			<Section>
				<Informative image={eyesAndBrowsPriceListImage} main='Eyes & Brows' description=''>
					<Catalog
						data={[
...
export const Head = () => <Seo title='Eyes & Brows' />;
